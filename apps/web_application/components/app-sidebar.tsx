    ...
    <>
      <div className="md:hidden fixed top-4 left-4 z-50">
        <Button
          ...
          className="bg-background shadow-sm border-border"
        >
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-sidebar-border/50 relative">
          <div
            className={cn(
              "flex items-center gap-2 font-bold text-lg overflow-hidden transition-all duration-300",
          ...
          <div
            className={cn(
              ...
              isCollapsed
                ? "md:absolute md:inset-x-0 md:justify-center"
                : "ml-auto",
            )}
          >
            <Button
